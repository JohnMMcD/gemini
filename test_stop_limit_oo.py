...
#        print(order.payload)
    ...
    def testStopLimitBuyWithWrongPrices(self):
    ...
    def testStopLimitSellWithWrongPrices(self):
    ...
    def testStopLimitBuyBelowTheMarket(self):
    ...
    def testStopLimitSellWayTooMuch(self):
    ...
    def testStopLimitSellWithNegativePrice(self):
    ...
    def testStopLimitBuyWithMissingPrice(self):
